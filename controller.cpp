...
void controller::create_new_file(model::model* model_ptr){
    ...
    view::create_buttons_for_treat_fle(new_file);
}
...
void controller::create_file(model::model* model_ptr, std::string& folder, std::string& file_name){
...
void controller::open_recent_file(model::model* model_ptr, const std::string& full_file_name){
    ...
    create_file(model::model* model_ptr, file_path, file_name);
}
