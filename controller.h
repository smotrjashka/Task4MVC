...
namespace controller {
    ...
    void create_new_file(model* model_ptr);
    void create_file(model* model_ptr, std::string& folder, std::string& file_name);
    void parse_full_file_name(const std::string& full_file_name, std::string& file_name, std::string& file_path);
    void open_recent_file(model* model_ptr, const std::string& full_file_name);
